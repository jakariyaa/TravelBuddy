                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <Link
                                href="/explore"
                                className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold rounded-full text-text-primary bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all hover:shadow-sm transform hover:-translate-y-0.5 active:scale-95 duration-200"
                            >
                        ...
                        <div className="relative z-10 grid grid-cols-2 gap-6 perspective-1000">
                            <div className="space-y-6 mt-16">
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <h3 className="font-bold text-text-primary text-lg">Paris, France</h3>
                                            <p className="text-sm text-text-secondary">Dec 12 - 20</p>
                                        </div>
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <h3 className="text-base font-bold text-text-primary">Sarah, 24</h3>
                                            <p className="text-xs text-text-secondary font-medium">Traveling Solo</p>
                                        </div>
                                    </div>
                                </motion.div>
                            </div>
                            ...
                            <div className="space-y-6">
                                ...
                                >
                                    ...
                                    <h3 className="text-4xl font-black mb-2 relative z-10">500+</h3>
