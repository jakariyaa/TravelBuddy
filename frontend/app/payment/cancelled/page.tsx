        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex flex-col">
            ...
            <main className="flex-grow flex items-center justify-center px-4 sm:px-6 lg:px-8 py-32 relative overflow-hidden">
                ...
                <div className="absolute inset-0 z-0 opacity-30 dark:opacity-10 pointer-events-none">
                    <div className="absolute top-0 right-0 w-96 h-96 bg-gray-200 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
                    <div className="absolute bottom-0 left-0 w-96 h-96 bg-gray-300 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2"></div>
                </div>
                ...
                >
                    <div className="mx-auto w-24 h-24 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center mb-8 shadow-inner">
                        <motion.div
                            initial={{ scale: 0 }}
                            animate={{ scale: 1 }}
                            transition={{ delay: 0.2, type: "spring" }}
                        >
                            <AlertCircle className="text-gray-500 dark:text-gray-400" size={48} strokeWidth={2.5} />
                        </motion.div>
                    </div>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <Link
                            href="/dashboard"
                            className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 font-bold rounded-2xl border-2 border-gray-100 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-500 hover:text-gray-900 dark:hover:text-white transition-all duration-300"
                        >
                            Back to Dashboard
                        </Link>
                    </div>
